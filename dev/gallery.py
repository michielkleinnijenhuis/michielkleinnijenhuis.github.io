...
imagedir = '/Users/michielk/TODO/images'
webdir = '/Users/michielk/workspace/www'
index=os.listdir(imagedir)
...
file = open(os.path.join(imagedir, 'gallery.html'), 'w')
...
next=os.listdir(imagedir)
image=os.listdir(imagedir)
page=os.listdir(imagedir)

next.append(os.path.join(imagedir, 'gallery.html'))
